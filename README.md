...
| --------------------------------------------------------------- | ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **tabata-ai**                                                   | App  | Tabata workout app (demo, for learning). Auth (Firebase), tabs (Dashboard, Workouts, History, Profile), AI-generated workouts (Gemini), REST API (Vercel), env secrets, Upstash, Capacitor. **Tested only on web and Android (OnePlus 10 Pro).** When viewed from web, use mobile view (DevTools/responsive mode) for best experience. Live demo: [https://silver-tabata-ai.vercel.app/](https://silver-tabata-ai.vercel.app/). See [apps/tabata-ai/README.md](apps/tabata-ai/README.md). |
...
## Tabata AI — live demo and screenshots
